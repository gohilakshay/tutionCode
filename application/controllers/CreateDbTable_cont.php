...
class CreateDbTable_cont extends CI_Controller
{
    function standard()
    {
        ...
        $ntype = explode(",",$type);
        $n = count($ntype);
        if ($this->db->table_exists("standard") ){
            echo "<script>alert('Standard Table Exists')</script>";
        }
        else{
    ...
    function semester()
    {
        ...
        $ntype = explode(",",$type);
        $n = count($ntype);
        if ($this->db->table_exists('semester') ){
            echo "<script>alert('Semester Table Exists')</script>";
        }
        else{
            $this->load->model('CreateTable');
    ...
    function branch()
    {
        ...
        if ($this->db->table_exists('branch') ){
            echo "<script>alert('Branch Table Exists')</script>";
        }
        else{
            $this->load->model('CreateTable');
