                            ...
                            <div class=" setup-content " id="step-1">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Address</label>
                                            <textarea rows=2 class="form-control border-input" placeholder="Home Address"  name = "address" name="address"  required><?php if(isset($_POST['address'])){echo $_POST['address'];} ?></textarea>
