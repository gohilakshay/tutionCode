...
<body>
    <div class="col-sm-4 col-sm-offset-4">
        <center><h1><b style="color: #68B3C8;">Digital Education</b></h1></center>
    </div>
    <div class="col-sm-4 col-sm-offset-4" align="center" style="margin-top: 20px;">
        <div class="card">
            <div class="header" style=" border: 2px solid white; background: #68B3C8; border-radius: 20px; padding: 10px">
