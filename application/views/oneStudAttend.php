            ...
            <div class="col-lg-12 col-sm-12">
                <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                    <div class="panel-heading templatemo-position-relative" style="background-color: #ffffff;     border-color: #9fcedc;">
                        <h3 class="text-uppercase" style="margin-top:10px;">Student Details</h3>
                    </div>
                </div>
            </div>
        </div>     
                            ...
                            <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered" >
                                        ...
                                        <tbody id="myTable"><?php $i=1; foreach($attendDetails  as $value): 
                                            $day = $value['dayDetails'];
                                            ?>
                                            <tr>
                                                <td><?php echo $i; $i++; ?></td>
                                                <td><a href="<?php echo site_url().'/Attendance_cont/viewAttendanceDetail/'.$day[0]->attend_ID; ?>"><?php print_r($day[0]->attend_date); ?></a></td>
                                                <td>
                                                    <?php 
                                                     if($value['attendP/A']==present){   
                                                    echo "<font color='green'>".$value['attendP/A']."</font>"; 
                                                     }
                                                    else {
                                                        echo "<font color='red'>".$value['attendP/A']."</font>"; 
                                                    }
                                                    ?>
                                                </td>
                                            </tr><?php endforeach; ?>
