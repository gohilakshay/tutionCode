            ...
            <div class="col-lg-12 col-sm-12">
                <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                    <div class="panel-heading templatemo-position-relative" style="background-color: #ffffff;     border-color: #9fcedc;">
                        <h3 class="text-uppercase" style="margin-top: 10px;">Update Faculty Profile</h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>DOB</label>
                                    <input type="date" class="form-control border-input" name="dob" value="<?php echo $teacher_data->t_dob; ?>" required>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label>EmailID</label>
                                    <input type="email" class="form-control border-input" name="email" value="<?php echo $teacher_data->t_email; ?>" placeholder="dummy@mail.com" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Mobile</label>
                                    <input type="text" class="form-control border-input" name="mobile" value="<?php echo $teacher_data->t_contact; ?>" placeholder="9876541236" required>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control border-input" name="qualification" value="<?php echo $teacher_data->qualification; ?>" placeholder="B.E" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Salary</label>
                                    <input type="text" class="form-control border-input" name="salary" value="<?php echo $teacher_data->salary; ?>" placeholder="10000" required>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Address</label>
                                    <textarea rows="2" type="text" class="form-control border-input" name="address" value="" required>
<?php echo $teacher_data->t_address; ?></textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control border-input" name="joiningdate" value="<?php echo $teacher_data->join_date; ?>" placeholder="FirstName &emsp;&emsp;&emsp;  MiddleName &emsp;&emsp;&emsp; LastName  " required>
